          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="info d-flex align-items-center">
                <div class="content">
                  ...
                  <p>Только для менеджеров и администраторов компании.</p>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form id="login-form" action="/manager/authorize/" method="post">
                    <div class="form-group">
                      <input id="login-username" type="text" name="logreg" required="" class="input-material">
                      <label for="login-username" class="label-material">Логин</label>
                    </div>
                    <div class="form-group">
                      <input id="login-password" type="password" name="pswrdreg" required="" class="input-material">
                      <label for="login-password" class="label-material">Пароль</label>
                    </div><button type="submit" id="login" class="btn btn-primary">Вход</button>
                    <!-- This should be submit button but I replaced it with <a> for demo purposes-->
                  </form><a href="#" class="forgot-pass">Забыли пароль?</a>
                </div>
              </div>
            </div>
          </div>
